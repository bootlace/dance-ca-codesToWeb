...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFF260259);
  late Color secondaryColor = const Color(0xFF049DD9);
  late Color tertiaryColor = const Color(0xFFD9BA82);
  late Color alternate = const Color(0xFF66CAF2);
  late Color primaryBackground = const Color(0xFFF2E8DC);
